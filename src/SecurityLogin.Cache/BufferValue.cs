...
{
    /// <summary>
    /// Represents values that can be stored in Cache.\
    /// In <see cref="https://github.com/StackExchange/StackExchange.Cache"/>
    /// </summary>
    public readonly struct BufferValue : IEquatable<BufferValue>, IComparable<BufferValue>, IComparable, IConvertible
    {
        internal static readonly BufferValue[] EmptyArray = Array.Empty<BufferValue>();

        private readonly object _objectOrSentinel;
        private readonly ReadOnlyMemory<byte> _memory;
        private readonly long _overlappedBits64;

        private BufferValue(long overlappedValue64, ReadOnlyMemory<byte> memory, object objectOrSentinel)
        {
        ...
        internal BufferValue(object obj, long overlappedBits)
        {   // this creates a bodged BufferValue which should **never**
        ...
        /// <summary>
        /// Creates a <see cref="BufferValue"/> from a string.
        /// </summary>
        public BufferValue(string value) : this(0, default, value) { }
        ...
        public static BufferValue Unbox(object value)
        {
        ...
        /// </summary>
        public static BufferValue EmptyString { get; } = new BufferValue(0, default, Sentinel_Raw);
        ...
        static readonly object s_DoubleNAN = double.NaN, s_DoublePosInf = double.PositiveInfinity, s_DoubleNegInf = double.NegativeInfinity,
            s_EmptyString = BufferValue.EmptyString;
        static readonly object[] s_CommonInt32 = Enumerable.Range(-1, 22).Select(i => (object)i).ToArray(); // [-1,20] = 22 values

        /// <summary>
        /// A null value.
        /// </summary>
        public static BufferValue Null { get; } = new BufferValue(0, default, null);
        ...
        /// <summary>
        /// Indicates whether two BufferValue values are equivalent.
        /// </summary>
        /// <param name="x">The first <see cref="BufferValue"/> to compare.</param>
        /// <param name="y">The second <see cref="BufferValue"/> to compare.</param>
        public static bool operator !=(BufferValue x, BufferValue y) => !(x == y);
        ...
        /// <param name="x">The first <see cref="BufferValue"/> to compare.</param>
        /// <param name="y">The second <see cref="BufferValue"/> to compare.</param>
        public static bool operator ==(BufferValue x, BufferValue y)
        {
            x = x.Simplify();
            y = y.Simplify();
        ...
        /// </summary>
        /// <param name="obj">The other <see cref="BufferValue"/> to compare.</param>
        public override bool Equals(object obj)
        {
            if (obj == null) return IsNull;
            if (obj is BufferValue typed) return Equals(typed);
        ...
        /// Indicates whether two BufferValue values are equivalent.
        /// </summary>
        /// <param name="other">The <see cref="BufferValue"/> to compare to.</param>
        public bool Equals(BufferValue other) => this == other;

        /// <inheritdoc/>
        public override int GetHashCode() => GetHashCode(this);
        private static int GetHashCode(BufferValue x)
        {
            x = x.Simplify();
        ...
        /// <summary>
        /// Compare against a BufferValue for relative order.
        /// </summary>
        /// <param name="other">The other <see cref="BufferValue"/> to compare.</param>
        public int CompareTo(BufferValue other) => CompareTo(this, other);

        private static int CompareTo(BufferValue x, BufferValue y)
        {
            try
            {
                x = x.Simplify();
        ...
        internal static BufferValue TryParse(object obj, out bool valid)
        {
            valid = true;
            switch (obj)
            {
        ...
        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="int"/>.
        /// </summary>
        /// <param name="value">The <see cref="int"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(int value) => new BufferValue(value, default, Sentinel_SignedInteger);

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="T:Nullable{int}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:Nullable{int}"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(int? value) => value == null ? Null : value.GetValueOrDefault();

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="long"/>.
        /// </summary>
        /// <param name="value">The <see cref="long"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(long value) => new BufferValue(value, default, Sentinel_SignedInteger);

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="T:Nullable{long}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:Nullable{long}"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(long? value) => value == null ? Null : (BufferValue)value.GetValueOrDefault();

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="ulong"/>.
        /// </summary>
        /// <param name="value">The <see cref="ulong"/> to convert to a <see cref="BufferValue"/>.</param>
        [CLSCompliant(false)]
        public static implicit operator BufferValue(ulong value)
        {
            const ulong MSB = 1UL << 63;
            return (value & MSB) == 0
                ? new BufferValue((long)value, default, Sentinel_SignedInteger) // prefer signed whenever we can
                : new BufferValue(unchecked((long)value), default, Sentinel_UnsignedInteger); // with unsigned as the fallback
        }

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="T:Nullable{ulong}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:Nullable{ulong}"/> to convert to a <see cref="BufferValue"/>.</param>
        [CLSCompliant(false)]
        public static implicit operator BufferValue(ulong? value) => value == null ? Null : (BufferValue)value.GetValueOrDefault();

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="uint"/>.
        /// </summary>
        /// <param name="value">The <see cref="uint"/> to convert to a <see cref="BufferValue"/>.</param>
        [CLSCompliant(false)]
        public static implicit operator BufferValue(uint value) => new BufferValue(value, default, Sentinel_SignedInteger); // 32-bits always fits as signed

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="T:Nullable{uint}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:Nullable{uint}"/> to convert to a <see cref="BufferValue"/>.</param>
        [CLSCompliant(false)]
        public static implicit operator BufferValue(uint? value) => value == null ? Null : (BufferValue)value.GetValueOrDefault();

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="double"/>.
        /// </summary>
        /// <param name="value">The <see cref="double"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(double value)
        {
            try
            {
                var i64 = (long)value;
                // note: double doesn't offer integer accuracy at 64 bits, so we know it can't be unsigned (only use that for 64-bit)
                if (value == i64) return new BufferValue(i64, default, Sentinel_SignedInteger);
            }
            catch { }
            return new BufferValue(BitConverter.DoubleToInt64Bits(value), default, Sentinel_Double);
        }

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="T:Nullable{double}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:Nullable{double}"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(double? value) => value == null ? Null : (BufferValue)value.GetValueOrDefault();

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from a <see cref="T:ReadOnlyMemory{byte}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:ReadOnlyMemory{byte}"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(ReadOnlyMemory<byte> value)
        {
            if (value.Length == 0) return EmptyString;
            return new BufferValue(0, value, Sentinel_Raw);
        }
        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from a <see cref="T:Memory{byte}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:Memory{byte}"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(Memory<byte> value) => (ReadOnlyMemory<byte>)value;

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="string"/>.
        /// </summary>
        /// <param name="value">The <see cref="string"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(string value)
        {
            if (value == null) return Null;
            if (value.Length == 0) return EmptyString;
            return new BufferValue(0, default, value);
        }

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="T:byte[]"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:byte[]"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(byte[] value)
        {
            if (value == null) return Null;
            if (value.Length == 0) return EmptyString;
            return new BufferValue(0, new Memory<byte>(value), value);
        }

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The <see cref="bool"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(bool value) => new BufferValue(value ? 1 : 0, default, Sentinel_SignedInteger);

        /// <summary>
        /// Creates a new <see cref="BufferValue"/> from an <see cref="T:Nullable{bool}"/>.
        /// </summary>
        /// <param name="value">The <see cref="T:Nullable{bool}"/> to convert to a <see cref="BufferValue"/>.</param>
        public static implicit operator BufferValue(bool? value) => value == null ? Null : value.GetValueOrDefault();

        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator bool(BufferValue value) => (long)value switch
        {
            0 => false,
            1 => true,
        ...
        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="int"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator int(BufferValue value)
            => checked((int)(long)value);

        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="long"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator long(BufferValue value)
        {
            value = value.Simplify();
            return value.Type switch
            {
                StorageType.Null => 0,// in Cache, an arithmetic zero is kinda the same thing as not-exists (think "incr")
        ...
        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="uint"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        [CLSCompliant(false)]
        public static explicit operator uint(BufferValue value)
        {
            value = value.Simplify();
            return value.Type switch
            {
        ...
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        [CLSCompliant(false)]
        public static explicit operator ulong(BufferValue value)
        {
            value = value.Simplify();
            return value.Type switch
            {
        ...
        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="double"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator double(BufferValue value)
        {
            value = value.Simplify();
            return value.Type switch
            {
        ...
        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="decimal"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator decimal(BufferValue value)
        {
            value = value.Simplify();
            return value.Type switch
            {
        ...
        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="float"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator float(BufferValue value)
        {
            value = value.Simplify();
            return value.Type switch
            {
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{double}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator double?(BufferValue value)
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{float}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator float?(BufferValue value)
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{decimal}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator decimal?(BufferValue value)
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{long}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator long?(BufferValue value)
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{ulong}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        [CLSCompliant(false)]
        public static explicit operator ulong?(BufferValue value)
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{int}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator int?(BufferValue value)
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{uint}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        [CLSCompliant(false)]
        public static explicit operator uint?(BufferValue value)
        ...
        /// <summary>
        /// Converts the <see cref="BufferValue"/> to a <see cref="T:Nullable{bool}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static explicit operator bool?(BufferValue value)
            => value.IsNull ? (bool?)null : (bool)value;

        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="string"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static implicit operator string(BufferValue value)
        {
            switch (value.Type)
            {
        ...
        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="T:byte[]"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static implicit operator byte[](BufferValue value)
        {
            switch (value.Type)
            {
                case StorageType.Null: return null;
                ...
                case StorageType.Int64:
                    ...
                    int len = Format.WriteRaw(span, value.OverlappedValueInt64, false, 0);
        ...
        /// <summary>
        /// Converts a <see cref="BufferValue"/> to a <see cref="ReadOnlyMemory{T}"/>.
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to convert.</param>
        public static implicit operator ReadOnlyMemory<byte>(BufferValue value)
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            ...
            if (conversionType == typeof(BufferValue)) return this;
        ...
        public bool TryParse(out long val)
        {
            switch (Type)
            {
                ...
                case StorageType.Null:
                    // in Cache-land 0 approx. equal null; so roll with it
                    val = 0;
                    return true;
            }
            val = default;
        ...
        /// <summary>
        /// Create a <see cref="BufferValue"/> from a <see cref="MemoryStream"/>.
        ...
        public static BufferValue CreateFrom(MemoryStream stream)
        {
        ...
        /// </summary>
        /// <param name="value">The <see cref="BufferValue"/> to check.</param>
        public bool StartsWith(BufferValue value)
        {
        ...
        private ReadOnlyMemory<byte> AsMemory(out byte[] leased)
        {
            switch (Type)
            {
                ...
                case StorageType.Int64:
                    ...
                    len = Format.WriteRaw(leased, OverlappedValueInt64) - 2; // drop the CRLF
                    return new ReadOnlyMemory<byte>(leased, 0, len);
                case StorageType.UInt64:
